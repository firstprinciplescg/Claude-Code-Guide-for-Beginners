...
const EssentialCommands = () => {
  return (
    <section data-section="essential-commands" className="mb-16">
      <h2 className="text-3xl font-bold text-gray-900 mb-8">Essential Commands</h2>
      ...
      <div className="space-y-8">
        ...
        <div data-subsection="core-slash-commands">
          <h3 className="text-2xl font-semibold text-gray-900 mb-6">Core Slash Commands</h3>
          
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  <code className="bg-blue-100 text-blue-800 px-2 py-1 rounded font-mono text-sm">/clear</code>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  <code className="bg-green-100 text-green-800 px-2 py-1 rounded font-mono text-sm">/model</code>
              ...
              <CardContent>
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-4">
                  ...
                  <div className="p-3 bg-blue-50 rounded-lg">
                    <h5 className="font-semibold text-blue-900 text-sm mb-1">Sonnet 4</h5>
                    <p className="text-blue-700 text-xs">Balanced capability</p>
                  </div>
                  <div className="p-3 bg-green-50 rounded-lg">
                    <h5 className="font-semibold text-green-900 text-sm mb-1">Haiku 3.5</h5>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  <code className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded font-mono text-sm">/config</code>
              ...
              <ExpandableSection title="Example: Custom Deploy Command" defaultExpanded={true}>
                <div className="space-y-4">
                  <p className="text-gray-600 text-sm">
                    Create <code className="bg-gray-100 px-1 rounded">.claude/commands/deploy.md</code>:
                  </p>
                  <CodeBlock 
                    code={`# Deploy Command
...
5. Push to the deployment branch`}
                  ...
                  />
                  <p className="text-gray-600 text-sm">
                    This file would then be accessible via <code className="bg-gray-100 px-1 rounded">/deploy</code> 
            ...
            <CardContent className="p-6">
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-green-500 pl-4">
                  <h4 className="font-semibold text-green-900 mb-2">Commands vs Conversation</h4>
                  <p className="text-gray-600 text-sm">
