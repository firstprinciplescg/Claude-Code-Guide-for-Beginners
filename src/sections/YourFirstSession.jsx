...
const YourFirstSession = () => {
  return (
    <section data-section="your-first-session" className="mb-16">
      <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-8">Your First Session</h2>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg mb-6">
              <h4 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">Example First Question</h4>
          ...
          <CardContent>
            <div className="space-y-6">
              <div className="border-l-4 border-green-500 pl-4">
                <h4 className="font-semibold text-green-900 dark:text-green-100 mb-2">Explanations</h4>
              ...
              <div className="border-l-4 border-blue-500 pl-4">
                <h4 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">Code Snippets</h4>
                <p className="text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg mt-6">
              <h4 className="font-semibold text-amber-900 dark:text-amber-100 mb-2">Transparency Principle</h4>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg mb-6">
              <h4 className="font-semibold text-green-900 dark:text-green-100 mb-2">Example Request</h4>
          ...
          <CardContent>
            ...
            <ExpandableSection title="What You'll Observe">
              <div className="space-y-4">
                <div>
                  <h5 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">1. Project Analysis</h5>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Claude analyzes your project structure to determine where utilities belong
                  </p>
                </div>
                <div>
                  <h5 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">2. Pattern Recognition</h5>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Checks for existing validation patterns to maintain consistency
                  </p>
                </div>
                <div>
                  <h5 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">3. Implementation</h5>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Creates the function with appropriate error handling
                  </p>
                </div>
                <div>
                  <h5 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">4. Testing</h5>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Generates comprehensive test cases including edge cases
                  </p>
                </div>
                <div>
                  <h5 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">5. Explanation</h5>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
