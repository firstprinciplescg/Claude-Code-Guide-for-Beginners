...
const IDEIntegration = () => {
  return (
    <section data-section="ide-integration" className="mb-16">
      <h2 className="text-3xl font-bold text-gray-900 mb-8">IDE Integration</h2>
      ...
      <div className="space-y-8">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="bg-blue-50 p-4 rounded-lg mb-6">
                <h4 className="font-semibold text-blue-900 mb-2">Auto-Installation System</h4>
        ...
        <div data-subsection="vscode-compatible">
          <h3 className="text-2xl font-semibold text-gray-900 mb-6">VS Code and Compatible Editors</h3>
                  ...
                  <div>
                    ...
                    <div className="space-y-3 text-sm">
                      <div className="flex items-start space-x-2">
                        ...
                        <span className="text-gray-600">Open your project in VS Code</span>
                      </div>
                      <div className="flex items-start space-x-2">
                        <span className="bg-blue-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs">2</span>
                        <span className="text-gray-600">Open the integrated terminal (Ctrl+` or from View menu)</span>
                      </div>
                      <div className="flex items-start space-x-2">
                        <span className="bg-blue-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs">3</span>
                        <span className="text-gray-600">Run <code className="bg-gray-100 px-1 rounded">claude</code></span>
                      </div>
                      <div className="flex items-start space-x-2">
                        <span className="bg-green-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs">✓</span>
                        <span className="text-gray-600">Extension auto-installs and you'll see a confirmation notification</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="border-l-4 border-blue-500 pl-4">
                      <h5 className="font-semibold text-blue-900 mb-2">Diff Viewer Integration</h5>
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <h5 className="font-semibold text-green-900 mb-2">Quick Launch</h5>
                      <p className="text-gray-600 text-sm">
        ...
        <div data-subsection="jetbrains-ides">
          <h3 className="text-2xl font-semibold text-gray-900 mb-6">JetBrains IDEs</h3>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex items-start space-x-2">
                      <span className="bg-blue-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs">1</span>
                      <span className="text-gray-600">Open your JetBrains IDE</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="bg-blue-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs">2</span>
                      <span className="text-gray-600">Open the integrated terminal</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="bg-blue-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs">3</span>
                      <span className="text-gray-600">Run <code className="bg-gray-100 px-1 rounded">claude</code></span>
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      <span className="text-gray-600">Plugin may auto-install or require manual installation from JetBrains marketplace</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="bg-green-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs">✓</span>
                      <span className="text-gray-600">Restart IDE if prompted</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="p-4 bg-green-50 rounded-lg">
                    <h4 className="font-semibold text-green-900 mb-2">Terminal to IDE</h4>
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <h4 className="font-semibold text-blue-900 mb-2">IDE to Terminal</h4>
                    <p className="text-blue-800 text-sm">
              ...
              <div className="space-y-6">
                <ExpandableSection title="Diff Viewer Optimization" defaultExpanded={true}>
                  <div className="space-y-3">
                    <p className="text-gray-600 text-sm">
                      Set Claude Code to use your IDE's diff viewer by default through the <code className="bg-gray-100 px-1 rounded">/config</code> command. 
