...
const CoreConcepts = () => {
  return (
    <section data-section="core-concepts" className="mb-16">
      <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-8">Core Concepts</h2>
      ...
      <div className="space-y-8">
        ...
        <div data-subsection="context-window-memory">
          <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">Context Window and Memory</h3>
          <Card>
            <CardContent className="p-6 pt-6">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg mb-6">
                <h4 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">What's Included in Context</h4>
              ...
              <ExpandableSection title="Understanding Context Limits" className="mb-4 mt-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg">
                    <h5 className="font-semibold text-amber-900 dark:text-amber-100 mb-2">When to Use /clear</h5>
                    <p className="text-amber-800 dark:text-amber-200 text-sm">
                      Using <code className="bg-amber-100 dark:bg-amber-900 text-amber-800 dark:text-amber-200 px-1 rounded">/clear</code> is like starting a fresh conversation with someone who already knows your codebase but isn't carrying baggage from previous discussions. Essential for productive long sessions.
                    </p>
                  </div>
                </div>
              </ExpandableSection>
        ...
        <div data-subsection="file-access">
          <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">File Access and Project Awareness</h3>
          <Card>
            <CardContent className="p-6 pt-6">
              <p className="text-gray-600 dark:text-gray-400 mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  <h4 className="font-semibold text-green-900 dark:text-green-100 mb-3">What Claude Can Access</h4>
                ...
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  <h4 className="font-semibold text-blue-900 dark:text-blue-100 mb-3">Security Features</h4>
        ...
        <div data-subsection="model-selection">
          <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">Model Selection and Capabilities</h3>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg mt-6">
                  <h5 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">Switching Models</h5>
                  <CodeBlock 
                    code={`/model`}
          ...
          <Card>
            <CardContent className="p-6 pt-6">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg mb-6">
                <h4 className="font-semibold text-green-900 dark:text-green-100 mb-2">What to Include in CLAUDE.md</h4>
